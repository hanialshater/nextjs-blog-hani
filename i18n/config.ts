...
export const translations: Record<Locale, Record<string, string>> = {
  en: {
    ...
    'page.demos': 'Demos',
    'page.demos.description':
      'Small standalone experiments and interactive mini projects that live inside the blog.',
    'page.tags': 'Tags',
    ...
    'demo.backToDemos': 'Back to demos',
    'demo.readRelatedPost': 'Read the related post',
  ...
  ar: {
    ...
    'page.demos': 'تجارب',
    'page.demos.description': 'تجارب صغيرة ومشاريع تفاعلية مستقلة تعيش داخل المدونة.',
    'page.tags': 'الوسوم',
    ...
    'demo.openDemo': 'افتح التجربة',
    'demo.backToDemos': 'العودة للتجارب',
    'demo.readRelatedPost': 'اقرأ المقال المرتبط',
    'home.readMore': 'اقرأ المزيد',
    'home.featured': 'مقالات مختارة',
  },
}
