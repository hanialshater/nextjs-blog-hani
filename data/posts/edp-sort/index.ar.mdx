...
المنحنى هو Kendall $\tau$ — صحة الجدول — مقابل عدد المباريات. القيمة الأعلى أفضل؛ الترتيب الكامل يعطي 1. السياسات اللي بتصوّب على الحدود بتحسم الجدول أسرع لأنها عم تصرف الميزانية وين الترتيب لسه ممكن يتحرك.
...
**Listwise judging** بيحوّل call واحدة لقيود كثيرة: ترتيب K items يعطي $\binom{K}{2}$ pairwise wins. هاي مش observations مستقلة، بسها لسه قيود ترتيب مفيدة.
