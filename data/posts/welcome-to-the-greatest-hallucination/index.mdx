...
ML is eating the world. In 2014, [Parallel Double Greedy Submodular Maximization](https://proceedings.neurips.cc/paper_files/paper/2014/file/63545404a8d4327e42a3416d73647995-Paper.pdf) appears at NIPS: approximation guarantees, parallelism, concurrency control. Familiar computer-science questions, gathered under an ML roof. The umbrella now covers the algorithms, the optimization, and the systems underneath. By the time all of that reaches the company deck, the whole stack is an AI achievement.
